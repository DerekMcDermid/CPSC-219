...
public abstract class SpriteBase {
    ...
    /*
     * Adds and removes images from screen.
     */
    ...
    /*
     * Adds the change in distance to current position.
     */
    public void move() {
    ...
    // Gets image to for sprite.
    public ImageView getView() {
        return imageView;
    }
    
    // Moves image based on location
    public void updateUI() {
        imageView.relocate(x, y);

    }
    
    ////// Setters and getters for size of sprite, and cener //////
